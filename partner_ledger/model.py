...
class PartnerLedgerReport(models.AbstractModel):
    _name = 'report.partner_ledger.partner_ledger_report'

    @api.model
    def render_html(self,docids, data=None):

        report_obj = self.env['report']
        report = report_obj._get_report_from_name('partner_ledger.partner_ledger_report')
        ...
        return report_obj.render('partner_ledger.partner_ledger_report', docargs)